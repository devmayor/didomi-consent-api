...
describe('UserService', () => {
  ...
  it('should be create a new user', async () => {
    ...
    expect(newUser).toHaveProperty('email', 'testEmail@gmail.com');
    expect(newUser).toHaveProperty('consents', []);
  });
  ...
  it('should be format data response', () => {
    const user = service.formatUser(testUser as unknown as User, [
      'email_notifications',
    ]);
    expect(user).toEqual({
